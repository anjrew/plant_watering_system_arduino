# 1 "/Users/earyzhe/dev/Arduino/plant_watering/plant_watering.ino"
# 1 "/Users/earyzhe/dev/Arduino/plant_watering/plant_watering.ino"
//////////////////////////////////////////////////////////////////
...
//    for (int i = 0; i <= moduleCount; i++) {
        ...
        if (currentModule.value < currentModule.moistureSetting){
            digitalWrite(currentModule.servoPin, 0x1);
            digitalWrite(pumpPin, 0x1);
            Serial.print("Watering...\n");
        }
        else{
            digitalWrite(currentModule.servoPin, 0x0);
