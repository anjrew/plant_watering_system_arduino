# 1 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino"
# 1 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino"
# 2 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino" 2
# 3 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino" 2
# 4 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino" 2

// For Temparature
# 7 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino" 2
...
// For RTC
# 15 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino" 2
# 16 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino" 2
RTC_DS3231 rtc;
int currentHour = 12;
...
void setup()
{
    setupSerialPorts();
    setup_wifi();
    client.setServer(mqtt_server, 11968);
    reconnect();
    setupRtc();
...
void setupRtc()
{
    ...
    if (rtc.lostPower())
    {
        ...
        rtc.adjust(DateTime((reinterpret_cast<const __FlashStringHelper *>(("Aug 11 2019"))), (reinterpret_cast<const __FlashStringHelper *>(("20:28:18")))));
        // This line sets the RTC with an explicit date &amp; time, for example to set
        // January 21, 2014 at 3am you would call:
        //     rtc.adjust(DateTime(2019, 7, 21, 1, 30, 0));
    }
    rtc.adjust(DateTime("Aug 11 2019", "20:28:18"));
}
...
void reconnect()
{
    ...
    while (!client.connected())
    {
        ...
        // Attempt to connect
        if (client.connect(clientId.c_str(), "xxtdtmwf", "c-0_VSx4qaOv"))
        {
            Serial.println("connected");

            //Once connected, publish an announcement...
            client.publish("test", "ESP32 client");
        }
        else
        {
...
void showNewData()
{
    if (newData == true)
    {
        ...
        client.publish("plants/berlin/oderstrasse/andrew", receivedChars);
        newData = false;
    }
}
...
void readEnviroment()
{
    ...
    client.publish("places/berlin/oderstrasse/andrew", finalString);
    delay(10);
}
...
void readCpuTemp()
{
    ...
    strcat(finalString, tempString);
    Serial.println(finalString);
    client.publish("things/esp32", finalString);
    delay(10);
}
...
void readSystemStats()
{
    ...
    char b[20];
    snprintf(b, 20, "%ld", esp_get_free_heap_size());
    strcat(finalString, b);

    strcat(finalString, ",minimun_ever_free_heap_size=");
    char c[20];
    snprintf(c, 20, "%ld", esp_get_minimum_free_heap_size());
    ...
    char e[20];
    snprintf(e, 20, "%ld", heap_caps_get_free_size((1<<2) /*|< Memory must allow for 8/16/...-bit data accesses*/));
    strcat(finalString, e);

    strcat(finalString, ",heap_caps_free_size_32=");
    char f[20];
    snprintf(f, 20, "%ld", heap_caps_get_free_size((1<<1) /*|< Memory must allow for aligned 32-bit data accesses*/));
    strcat(finalString, f);

    strcat(finalString, ",dRAM=");
    char g[20];
    double dram = static_cast<double>(heap_caps_get_free_size((1<<2) /*|< Memory must allow for 8/16/...-bit data accesses*/));
    snprintf(g, 20, "%ld", dram);
    strcat(finalString, g);

    strcat(finalString, ",dRAM_iRAM=");
    char h[20];
    double dramIram = static_cast<double>(heap_caps_get_free_size((1<<1) /*|< Memory must allow for aligned 32-bit data accesses*/));
    ...
    char j[20];
    snprintf(j, 20, "%ld", heap_caps_get_largest_free_block((1<<2) /*|< Memory must allow for 8/16/...-bit data accesses*/));
    strcat(finalString, j);

    strcat(finalString, ",heap_caps_largest_free_block_32=");
    char k[20];
    snprintf(k, 20, "%ld", heap_caps_get_largest_free_block((1<<1) /*|< Memory must allow for aligned 32-bit data accesses*/));
    strcat(finalString, k);

    strcat(finalString, ",smlst_free_mem_stack=");
    char l[20];
    snprintf(l, 20, "%ld", uxTaskGetStackHighWaterMark(
# 375 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino" 3 4
                                                      __null
# 375 "/Users/earyzhe/dev/Arduino/plant_watering/Esp32_DevBoard_send_message_to_telegraf_via_mqtt _with_serial_communication_to_arduino_mini/sketch_jul29a_with_time_api_and_rtc/sketch_jul29a_with_time_api_and_rtc.ino"
                                                          ));
...
void timeLoop()
{
    Serial.print(rtc.now().hour(), 10);
    Serial.print(':');
    Serial.print(rtc.now().minute(), 10);
    Serial.print(':');
    Serial.print(rtc.now().second(), 10);
